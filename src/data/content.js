...
const EN_PROJECTS = [
  ...
  },
  {
    ...
    bullets: ['Full winery management platform, built in Java', 'Role-based access: CEO, managers, warehouse, accounting', 'Orders, inventory, worker scoring, auto task generation', 'Team project centred on architecture and design patterns'],
  ...
  },
  {
    ...
    bullets: ['Android app in Kotlin and Jetpack Compose', 'Flask dispatcher API on Railway routes to Gemini 2.5 Flash', 'Base64 image input for multimodal prompts', 'Relays responses straight to Telegram'],
  ...
  },
  {
    ...
    bullets: ['JavaScript front-end UI experiment', 'Responsive composition and smooth animation', 'Component-driven layout'],
  ...
  },
  {
    ...
    bullets: ['Command-line finite-state machine in Java', 'State transitions, input parsing, acceptance logic', 'OOP course project, operated entirely via CLI'],
...
const BG_PROJECTS = [
  ...
  },
  {
    ...
    bullets: ['Платформа за управление на винарна, на Java', 'Роли: директор, мениджъри, склад, счетоводство', 'Поръчки, наличности, оценка на работници, задачи', 'Екипен проект с фокус върху архитектура и design patterns'],
  ...
  },
  {
    ...
    bullets: ['Android приложение с Kotlin и Jetpack Compose', 'Flask dispatcher API в Railway към Gemini 2.5 Flash', 'Base64 изображения за мултимодални заявки', 'Препраща отговори директно към Telegram'],
    tags: ['Kotlin', 'Jetpack Compose', 'Android', 'Python', 'Flask', 'Gemini API', 'Railway'],
    link: 'https://github.com/KamenKarchev/PipePrompt-BackEnd',
    image: '/images/project-pipeprompt.jpg',
  },
  {
    ...
    bullets: ['JavaScript front-end UI експеримент', 'Responsive композиция и плавни анимации', 'Компонентно-ориентиран layout'],
    tags: ['JavaScript', 'HTML', 'CSS'],
    link: 'https://github.com/KamenKarchev/PunchPro',
    image: '/images/project-punchpro.jpg',
  },
  {
    ...
    bullets: ['Command-line finite-state machine на Java', 'Преходи между състояния, parsing, acceptance logic', 'ООП курсов проект, изцяло през CLI'],
...
export const CONTENT = {
  en: {
    ...
    hero: {
      ...
      stack: ['Elixir', 'Java', 'Kotlin', 'React', 'C#'],
    ...
    sections: {
      ...
      timeline: { eyebrow: 'Second article', title: 'The path that built it' },
      projects: { eyebrow: 'Third article', title: 'Projects' },
    ...
    request: {
      ...
      title: 'Tell me what you want built.',
      deck: 'Enough detail to judge scope and fit. I answer every request, including the ones I turn down.',
      fields: {
        name:        { label: 'Your name', placeholder: 'Jane Doe' },
        email:       { label: 'Email', placeholder: 'jane@example.com' },
        projectName: { label: 'Project', placeholder: 'What is it called?' },
        description: { label: 'What is it', placeholder: 'What the project is, what it needs to do, and where it stands today.' },
        engagement:  { label: 'Paid or free' },
        timeline:    { label: 'Scope and timeline', placeholder: 'e.g. a few weeks, or a hard deadline you have' },
        budget:      { label: 'Budget, if you have one', placeholder: 'Optional' },
      },
      engagementOptions: {
        paid:      'Paid work',
        free:      'Asking for free work',
      ...
      successBody: "I'll read it and reply to the email you gave. If it's a fit, we'll talk scope from there.",
      errors: {
        required: 'This one is needed.',
        tooShort: 'A bit more detail, please.',
        tooLong:  'That is longer than the form accepts.',
        invalid:  'That does not look like an email address.',
        rateLimited: 'That is several requests in a short time. Try again in an hour.',
        network: 'The request did not go through. Try again in a moment.',
        unconfigured: 'The form is not connected to its database yet.',
      },
    },
    contact: {
      eyebrow: 'Back page',
  ...
  bg: {
    ...
    sections: {
      ...
      timeline: { eyebrow: 'Втора статия', title: 'Пътят, който го изгради' },
      projects: { eyebrow: 'Трета статия', title: 'Проекти' },
    ...
    request: {
      ...
      title: 'Разкажи ми какво искаш да изградя.',
      deck: 'Достатъчно детайли, за да преценя обхвата и съвместимостта. Отговарям на всяко запитване, включително на тези, които отказвам.',
      fields: {
        name:        { label: 'Твоето име', placeholder: 'Иван Иванов' },
        email:       { label: 'Имейл', placeholder: 'ivan@example.com' },
        projectName: { label: 'Проект', placeholder: 'Как се казва?' },
        description: { label: 'Какво представлява', placeholder: 'Какъв е проектът, какво трябва да прави и докъде е стигнал.' },
        engagement:  { label: 'Платено или безплатно' },
        timeline:    { label: 'Обхват и срок', placeholder: 'напр. няколко седмици или твърд краен срок' },
        budget:      { label: 'Бюджет, ако имаш', placeholder: 'По желание' },
      },
      engagementOptions: {
        paid:      'Платена работа',
        free:      'Молба за безплатна работа',
        undecided: 'Още не съм сигурен',
      },
      optional: 'по желание',
      submit: 'Изпрати запитване',
      submitting: 'Изпращане…',
      successTitle: 'Запитването е получено.',
      successBody: 'Ще го прочета и ще отговоря на посочения имейл. Ако си пасваме, оттам ще уточним обхвата.',
      errors: {
        required: 'Това поле е необходимо.',
        tooShort: 'Малко повече детайли, моля.',
        tooLong:  'Това е по-дълго от допустимото.',
        invalid:  'Това не прилича на имейл адрес.',
        rateLimited: 'Това са няколко запитвания за кратко време. Опитай пак след час.',
        network: 'Запитването не премина. Опитай пак след момент.',
        unconfigured: 'Формата още не е свързана с базата данни.',
      },
    },
    projects: {
